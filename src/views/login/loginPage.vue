  ...
  <div class="login">
    ...
    <div class="content">
      ...
      <div class="loginMethod">
        <a href="https://api.gonkamasn.com/api-user/oauth2/authorization/github">
          <el-image style="width: 32px; height: 32px" :src="github" fit="contain"></el-image>
        </a>
        <a href="https://api.gonkamasn.com/api-user/oauth2/authorization/messaging-client-oidc">
          <el-image style="width: 32px; height: 32px" :src="vivo" fit="contain"></el-image>
        </a>
      </div>
    </div>
  </div>
